      ...
      <div className="container">
        ...
        <div className="inputbutton">
          <input
            ...
            type="text"
            placeholder='Coloque Aqui Seu Cep exemplo"01001-000"'
          />
        ...
        {cep && Object.keys(cep).length > 0 && (
          <div className="result">
            <p>
              Cep: <strong>{cep.cep}</strong>
            </p>
            <p>
              UF: <strong>{cep.uf}</strong>
            </p>
            <p>
              Estado: <strong>{cep.estado}</strong>
            </p>
            <p>
              Logradouro: <strong>{cep.logradouro}</strong>
            </p>
            <p>
              Localidade: <strong>{cep.localidade}</strong>
            </p>
            <p>
              DDD: <strong>{cep.ddd}</strong>
            </p>
            <p>
              Regiao: <strong>{cep.regiao}</strong>
            </p>
